...
from himiko import dispatcher, updater, TOKEN, WEBHOOK, OWNER_ID, DONATION_LINK, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from himiko.modules import ALL_MODULES
from himiko.modules.helper_funcs.chat_status import is_user_admin
from himiko.modules.helper_funcs.misc import paginate_modules
...
I'm a group management bot/ Have a look at the following for an idea of some of \
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("himiko.modules." + module_name)
